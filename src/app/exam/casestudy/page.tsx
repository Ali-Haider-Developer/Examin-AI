  ...
  const startExamAttempt = async () => {
    ...
    try {
      ...
      if (!examDetails?.time_limit || examDetails.time_limit <= 0) {
        ...
        setTimeLeft(examDetails.time_limit);
      }
    } catch (err) {
        ...
        <div className="w-full max-w-xl bg-[#1a0066]/80 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border-2 border-[#00fff7] text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-8 pt-8">
            ...
            <div className="bg-[#050014]/80 rounded-xl p-4 flex flex-col items-center border-2 border-[#1a0066]">
              ...
              <span className="font-bold text-lg text-[#e0e0ff]">{examDetails?.time_limit} seconds</span>
            </div>
          </div>
          <div className="px-8 pt-8">
            <div className="bg-[#1a0066]/60 border-l-4 border-[#00fff7] rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#e0e0ff]">This exam requires detailed case study answers. Read the case description carefully and provide a thorough response. You can navigate between questions using the previous and next buttons.</p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-3xl bg-[#1a0066]/80 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border-2 border-[#00fff7]">
          ...
          <div className="p-6">
            <div className="bg-[#050014]/80 p-5 rounded-xl mb-6 border-2 border-[#1a0066]">
              ...
              <p className="mt-2 text-[#00fff7] text-base">{currentQuestion?.question_data.case_description}</p>
            </div>
          <textarea
            ...
            onChange={(e) =>
              ...
              className="w-full h-40 border-2 border-[#00fff7] rounded-xl p-4 mt-4 focus:ring-2 focus:ring-[#00fff7] focus:border-[#00fff7] outline-none transition-all duration-200 bg-[#1a0066] text-[#e0e0ff] placeholder-[#7f00ff]"
              placeholder="Type your case study answer here..."
            />
