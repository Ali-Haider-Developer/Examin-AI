...
const ShortQuestionsPage = () => {
  ...
  // Defensive rendering for questions
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center" style={{ background: THEME.gradient, backgroundSize: '400% 400%' }}>
      {loading ? (
        ...
        <motion.div
          className="w-full max-w-xl bg-[#1a0066]/80 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border-2 border-[#00fff7]"
          ...
          <div className="px-8 pt-8">
            <div className="bg-[#1a0066]/60 border-l-4 border-[#00fff7] rounded-xl p-4 flex items-start gap-3">
              <svg className="w-5 h-5 text-[#00fff7] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                ...
                <p className="text-xs text-[#e0e0ff]">This exam requires short answers. Be concise and to the point. You can navigate between questions using the previous and next buttons.</p>
              </div>
            </div>
          </div>
          {/* Start Button */}
        ...
        <motion.div
          className="w-full max-w-3xl bg-[#1a0066]/80 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border-2 border-[#00fff7]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5 }}
        >
          <div className="border-b-2 border-[#00fff7]/30 p-6">
            ...
            <div className="bg-[#050014]/80 p-5 rounded-xl mb-6 border-2 border-[#1a0066]">
              ...
              className="w-full h-48 border-2 border-[#00fff7] rounded-xl p-4 mt-4 focus:ring-2 focus:ring-[#00fff7] focus:border-[#00fff7] outline-none transition-all duration-200 bg-[#1a0066] text-[#e0e0ff] placeholder-[#7f00ff]"
