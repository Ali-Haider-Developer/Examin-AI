          ...
          <div className="px-8 pt-8">
            <div className="bg-[#1a0066]/60 border-l-4 border-[#00fff7] rounded-xl p-4 flex items-start gap-3">
              <svg className="w-5 h-5 text-[#00fff7] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                ...
                <p className="text-xs text-[#e0e0ff]">This exam contains True/False questions. Select the correct answer for each question. You can navigate between questions using the previous and next buttons.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#050014]/80 p-5 rounded-xl mb-6 border-2 border-[#1a0066]">
              ...
              <div className="space-y-3 mb-8">
                ...
                className={`p-4 rounded-xl cursor-pointer border-2 transition-all duration-200 ${
                    ...
                    ? "bg-[#00fff7]/10 border-[#00fff7] shadow-sm"
                    : "bg-[#1a0066]/40 border-[#1a0066] hover:border-[#00fff7] hover:bg-[#00fff7]/5"
                  }`}
                  onClick={() =>
                    handleOptionSelect(
                    currentQuestion?.id || "",
                ...
                className={`p-4 rounded-xl cursor-pointer border-2 transition-all duration-200 ${
                    ...
                    ? "bg-[#ff00ea]/10 border-[#ff00ea] shadow-sm"
                    : "bg-[#1a0066]/40 border-[#1a0066] hover:border-[#ff00ea] hover:bg-[#ff00ea]/5"
                  }`}
                  onClick={() =>
                    handleOptionSelect(
                    currentQuestion?.id || "",
