          ...
          <div className="px-8 pt-8">
            <div className="bg-[#1a0066]/60 border-l-4 border-[#00fff7] rounded-xl p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#e0e0ff]">This exam requires long, essay-style answers. Be thorough and detailed. You can navigate between questions using the previous and next buttons.</p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-3xl bg-[#1a0066]/80 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border-2 border-[#00fff7]">
          ...
          <textarea
            ...
            onChange={(e) =>
              ...
              className="w-full h-64 border-2 border-[#00fff7] rounded-xl p-4 mt-4 focus:ring-2 focus:ring-[#00fff7] focus:border-[#00fff7] outline-none transition-all duration-200 bg-[#1a0066] text-[#e0e0ff] placeholder-[#7f00ff]"
